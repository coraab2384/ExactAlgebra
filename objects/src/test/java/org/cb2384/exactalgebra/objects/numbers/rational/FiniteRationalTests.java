...
public final class FiniteRationalTests {
    
    private static final FiniteRational ZERO = FiniteRational.valueOfStrict(0, 1);
    
    private static final List<FiniteRational> ONE_TO_SIXTEEN = LongStream.rangeClosed(1, 32)
            .mapToObj(l -> FiniteRational.valueOfStrict(l, 2))
            .toList();
    
    private static final List<FiniteRational> NEG_ONE_TO_SIXTEEN = LongStream.rangeClosed(1, 32)
            .mapToObj(l -> FiniteRational.valueOfStrict(-l, 2))
            .toList();
    ...
    private static final FiniteRational BIG_TEST_NUM = FiniteRational.valueOfStrict(BIG_TEST_INT, 1);
    
    private static final FiniteRational BIG_TEST_NEG_DEN = FiniteRational.valueOfStrict(1, -BIG_TEST_INT);
    
    private static final List<FiniteRational> ALL_FR = Stream.of(NEG_ONE_TO_SIXTEEN.stream(),
                    Stream.of(ZERO, BIG_TEST_NUM, BIG_TEST_NEG_DEN), ONE_TO_SIXTEEN.stream())
            .flatMap(UnaryOperator.identity())
            .sorted()
            .toList();
    
    private static FiniteRational get(
            int numerator,
            int denominator
    ) {
            ...
            case -2 -> {
                if (numerator < 0) {
                    yield (numerator >= -32)
                            ...
                            : FiniteRational.valueOfStrict(-numerator, -denominator);
                }
                yield (numerator <= 32)
    ...
    public final class ValueOfStrictTests {
        @Test
        public void testTooBigInputLongNum() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOfStrict(Long.MIN_VALUE, 1)
            );
        }
        
        @Test
        public void testTooBigInputLongDen() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOfStrict(Long.MAX_VALUE, -5)
            );
        }
        ...
        public void test0LongDen() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOfStrict(3934867523948L, 0L)
            );
        }
        
        @Test
        public void testStrictness() {
            var expected = new FiniteRational(5L, 1L);
            var actual = FiniteRational.valueOfStrict(5, 1);
            assertEquals(expected, actual);
        }
        
        @Test
        public void test0IntDen() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOfStrict(-349587623, 0)
            );
        }
    }
    ...
    public final class ValueOfTests {
        ...
        public void test0LongDen() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOf(3934867523948L, 0L)
            );
        }
        ...
        public void test0IntDen() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> FiniteRational.valueOf(-349587623, 0)
            );
        }
    }
    ...
    public final class NumeratorTests {
        ...
        @Test
        public void testNumeratorLong() {
            assertEquals(-1, BIG_TEST_NEG_DEN.numeratorPrim());
        }
        
        @Test
        public void testNumeratorInt() {
            assertEquals(1, BIG_TEST_NEG_DEN.numeratorIntUnsigned());
        }
    }
    ...
    public final class DenominatorTests {
        ...
        @Test
        public void testDenominatorLong() {
            assertEquals(1, BIG_TEST_NUM.denominatorPrim());
        }
        
        @Test
        public void testDenominatorInt() {
            assertEquals(-BIG_TEST_INT, BIG_TEST_NEG_DEN.denominatorIntSigned());
        }
    }
    ...
    public final class WholeTests {
        ...
        @Test
        public void testWholePrim() {
            assertEquals(-50, get(101, -2).wholePrim());
        }
    }
    ...
    public final class RoundZTests {
        ...
        public void testThisNoArg() {
            assertEquals(
                    FiniteRational.valueOf(BIG_TEST_INT, 1),
                    BIG_TEST_NUM.roundZ()
            );
        }
    ...
    public final class ToBigDecimalTests {
        ...
        private static final FiniteRational TEST = FiniteRational.valueOfStrict(BIG_TEST_INT, -ANS_DEN);
    ...
    public final class QueryTests {
        ...
        public void testNot0() {
            assertTrue(ONE_TO_SIXTEEN.stream().noneMatch(FiniteRational::isZero));
        }
        ...
        public void testNot1() {
            assertTrue(NEG_ONE_TO_SIXTEEN.stream().noneMatch(FiniteRational::isOne));
        }
        
        @Test
        public void testNegIsNeg() {
            assertTrue(NEG_ONE_TO_SIXTEEN.stream().allMatch(FiniteRational::isNegative));
        }
        
        @Test
        public void testNotNeg() {
            assertTrue(ONE_TO_SIXTEEN.stream().noneMatch(FiniteRational::isNegative));
        }
        
        @Test
        public void testWhole() {
            assertTrue(ALL_FR.stream()
                    .filter(r -> r.denominatorPrim() == 1)
                    .allMatch(FiniteRational::isWhole) );
        }
    }
    ...
    public final class NegateAndAbsTests {
        ...
        public void negationTest() {
            var actual = NEG_ONE_TO_SIXTEEN.stream().map(FiniteRational::negated).toList();
            assertTrue(IntStream.range(1, 32).allMatch(i -> ONE_TO_SIXTEEN.get(i).equiv(actual.get(i))));
        }
        
        @Test
        public void negAbsTest() {
            var actual = NEG_ONE_TO_SIXTEEN.stream().map(FiniteRational::magnitude).toList();
            assertTrue(IntStream.range(1, 32).allMatch(i -> ONE_TO_SIXTEEN.get(i).equiv(actual.get(i))));
        }
    ...
    public final class ComparisonTests {
        ...
        public void testNull() {
            tryNull(
                    (Consumer<FiniteRational>) ZERO::compareTo,
    ...
    public final class EquivTests {
        ...
        public void testNull() {
            tryNull(
                    (Consumer<FiniteRational>) ZERO::equiv,
    ...
    public final class EqualsAndHCTests {
        ...
        public void testEqualsAndHCContract() {
            int size = ALL_FR.size();
            
            for (int i = 0; i < size; i++) {
                FiniteRational testI = ALL_FR.get(i);
                for (int j = 0; j <size; j++) {
                    FiniteRational testJ = ALL_FR.get(j);
        ...
        public void testSubclassNotEqual() {
            assertTrue(ALL_FR.stream().allMatch(r -> {
                Rational testR = FiniteRational.valueOf(r.numeratorPrim(), r.denominatorPrim());
        ...
        @Test
        public void testNull() {
            assertTrue(ALL_FR.stream().noneMatch(r -> r.equals(null)));
        }
    }
    ...
    public final class SumTests {
        ...
        public void testNull() {
            tryNull(
                    (Consumer<FiniteRational>) ZERO::sum,
    ...
    public final class DifferenceTests {
        ...
        public void testNull() {
            tryNull(
                    (Consumer<FiniteRational>) ZERO::difference,
    ...
    public final class ProductTests {
        ...
        public void testNull() {
            tryNull(
                    ...
                    (Consumer<FiniteRational>) ZERO::product,
    ...
    public final class QuotientTests {
        ...
        public void testQuotientAI() {
            var expected = FiniteRational.valueOfStrict(5, -32);
        ...
        public void testQuotientAN() {
            ...
            var actual = get(9, 1).quotient(
                    (AlgebraNumber) FiniteRational.valueOfStrict(6, -5));
            assertEquals(expected, actual);
        }
        ...
        public void testNull() {
            tryNull(
                    (Consumer<FiniteRational>) ZERO::quotient,
    ...
    public final class QuotientZWithRemainderTests {
        ...
        public void testQuoRemainAN() {
            var expected = new NumberRemainderPair<>(FiniteInteger.valueOfStrict(-4),
                    FiniteRational.valueOfStrict(5, -4));
            var actual = FiniteRational.valueOfStrict(69, -4).quotientZWithRemainder(
    ...
    public final class QuotientRoundZTests {
        ...
        public void testNoRoundingMode() {
            var actual = FiniteRational.valueOfStrict(11, -1224).quotientRoundZ(
    ...
    public final class RootWithRemainderTests {
        ...
        public void testAIRootWRemain() {
            var expected = new NumberRemainderPair<>(FiniteInteger.valueOfStrict(-3),
                    get(3, -2));
            var actual = FiniteRational.valueOfStrict(489, -2)
    ...
    public final class RootRoundTests {
        ...
        public void testIntRootWRemain() {
            var expected = FiniteInteger.valueOfStrict(-4);
            var actual = FiniteRational.valueOfStrict(85, -3)
